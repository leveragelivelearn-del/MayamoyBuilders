          ...
          <footer className="mt-40 pt-20 border-t border-neutral-100 dark:border-neutral-900 flex flex-col items-center gap-12">
            <div className="flex items-center gap-4">
              <div className="h-16 w-16 rounded-full bg-neutral-100 dark:bg-neutral-900 p-1 relative overflow-hidden">
                <Image
                  src={blog.author?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(blog.author?.name || 'Mayamoy Builders')}`}
                  alt="Author"
                  fill
              ...
              <div className="flex flex-col">
                <span className="text-xs font-black uppercase tracking-widest">{blog.author?.name || 'Mayamoy Builders Curators'}</span>
