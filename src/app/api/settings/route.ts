  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Mayamoy Builders",
        contact: {
        ...
        marqueeText: "Welcome to Mayamoy Builders!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Mayamoy Builders",
