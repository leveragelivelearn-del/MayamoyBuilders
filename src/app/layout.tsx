...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      title: {
        default: settings.metaTitle || settings.brandName || "Mayamoy Builders",
        template: `%s | ${settings.brandName || "Mayamoy Builders"}`,
      },
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "Mayamoy Builders",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "Mayamoy Builders",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "Mayamoy Builders",
        type: 'website',
      },
      twitter: {
